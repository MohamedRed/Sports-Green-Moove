...
includes(files.androidVerificationNotes, "Appetize email/password signup", "Android notes document Appetize email auth");
...
includes(files.automatedFlowEvidence, "appetize-android-email-signup-2026-06-17.png", "Automated flow evidence references refreshed Appetize email auth screenshot");
