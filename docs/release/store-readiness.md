...
- Store screenshots showing active ride tracking, Google Maps route preview, stale-location warning, emergency contact action, and permission education. Android emulator screenshots for these five surfaces are generated by Native CI and recorded in the in-progress manifest; final store submission still needs the complete evidence package.
